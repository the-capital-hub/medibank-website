...
export default function Page() {
  ...
  return (
    <div>
      ...
      <div
        id="about1"
        className="mx-16 h-screen flex flex-col md:flex-row items-center"
      >
        <div className="container text-left text-[22px] pt-16 w-full md:w-1/2">
      ...
      <div className="bg-white">
        <h2 className="container text-center text-[28px] md:text-[30px] font-bold pt-0">
          Founding Team
        </h2>
        <div className="founding-team py-16 mx-16 rounded-[30px] bg-[#F6F5FF]">
          <div className="flex justify-around gap-5 items-center flex-wrap">
            {founderData.map((item, index) => (
              <div key={index} className="group relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-80 mb-4">
				<div className="relative mx-4 mt-4 text-gray-700 bg-white shadow-lg bg-clip-border rounded-xl h-[300px] sog_animation group-hover:rotate-y-180">
					<div className='absolute top-0 bottom-0 w-full h-full backface_hidden overflow-hidden'>
						{' '}
					<Image src={item.imgurl} className='w-full h-full' width="612" height="612" alt="profile-picture" />
					</div>
					<div className=' absolute top-0 bottom-0 w-full h-full backface_hidden rotate-y-180 bg-[#927e7e] text-white'>
						{' '}
						{/*backcard */}
        ...
        <div className="w-4/5 container py-16">
          ...
          <div className='flex justify-around items-center flex-col md:flex-row w-full flex-wrap'>
                        {advisoryData.map((item,index)=>{
                            return(
                                <div key={index} className='group w-full md:w-1/5 md:mx-1 mb-2 md:my-4 bg-white rounded-[10px]'>
                                <div className="relative  h-56 sog_animation group-hover:rotate-y-180">
                                    <div className='absolute top-0 bottom-0 w-full h-full backface_hidden overflow-hidden rounded-[10px]'>
                                        {' '}
                                    <Image src={item.imgurl} className=' rounded-[10px]' width="400" height="400" alt="profile-picture" />
                                    </div>
                                    ...
                                    <div className='text-center text-[12px] py-2'>{item.Designation}</div>
                                </div>
                            )
                        })}
