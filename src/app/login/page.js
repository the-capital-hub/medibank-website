...
export default function page() {
  return (
    <div className='mt-[100px] bg-blue-50'>
        ...
        <Image src="/images/coming.png" className='m-auto' width="200" height="200" alt='coming soon'/>
            {/* <div className='text-green-400'>LOGIN</div> */}
            <div className='flex flex-col md:flex-row justify-between w-full h-auto'>
                <div className=''>
                    <div className='py-2 text-blue-400 font-medium'>INDIVIDUAL USER</div>
...
<div className='max-w-lg mx-auto text-center'>
    ...
    <div className='flex justify-between'>
       ...
       <Image src='/images/appstore.png' width='100' height='50' alt="qr" />
                ...
                <div className=''>
                <div className='py-2 text-blue-400 font-medium'>DOCTOR / CLINIC</div>
  ...
  <div className='max-w-lg mx-auto py-6 text-blue-500 text-center'>
    Doctors who are not registerd with us and want to come onboard please contact us on <a href='mailto:support@medilog.in'>support@medilog.in</a> to go through the onboarding process.
  </div>
