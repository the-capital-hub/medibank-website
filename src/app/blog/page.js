  ...
  return (
    <div className='mt-[100px]'>
         <div className='bg-slate-500'>
                ...
                <div className='text-center my-8 text-[28px] font-bold text-white'>Blogs</div>
                    <div className='flex justify-around items-center flex-col md:flex-row w-full flex-wrap'>
                        {blogList.map((item, index) => {
                            return (   
                                 <div key={index} className='shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-[10px] p-4 bg-white w-full m-0 my-2 md:w-1/3 md:m-4 '>
                                        ...
                                        <div className='text-left text-[#636384] text-[14px]'>Source: {item.source}</div>
                                    </div>
