...
export default function page() {
  return (
    ...
    <header className="bg-blue-600 text-white p-6">
        <h1 className="text-2xl font-bold">India Bullish on AI in Healthcare Without Electronic Health Records</h1>
    </header>

    <main className="md:p-6 max-w-4xl mx-auto">
        <section className="mb-6">
            <p className="text-lg mb-4">
                With more than 75% of outpatients and more than 60% of inpatients in India being treated in private healthcare facilities, why is the adoption of EHR a challenge in India?
            </p>
            <p className="text-lg mb-4">
                79-year-old Karan Singh, a lung cancer patient undergoing treatment since 11 years, recalls the number of times he had to carry folders bulging with photocopies of medical reports, the repeated blood tests in different hospitals, and the sleepless nights caused by painful side effects of drugs, chemotherapy, and radiation.
            </p>
            <p className="text-lg mb-4">
        ...
        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Kerala’s Success with EHR</h2>
            <p className="mb-4">
        ...
        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">The National Digital Health Blueprint (NDHB)</h2>
            <p className="mb-4">
                The National Digital Health Blueprint (NDHB), proposed in 2019, plans to establish and manage the health data and infrastructure required for its seamless exchange, promoting adoption of open standards and developing several digital health systems that span from wellness to disease management. Interestingly, the NDHB also aims at leveraging information systems already existing in the health sector.
            </p>
            <p className="mb-4">
                Fortunately, today, healthcare experts and clinicians in India do understand the potential of artificial intelligence and big data. However, implementation of standardized electronic health records can only be seen in radiology, billing, and registration systems.
            </p>
        </section>

        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Challenges and Potential of EHR in India</h2>
            <p className="mb-4">
                “Most of the IT systems in leading hospitals are primarily for billing and their records and not EHRs in a real sense. The administration has to understand the fact that there has to be a plan to make EHRs a reality, and without EHRs, we cannot have any clinical data for implementing AI or Big Data, as there will be no data,” said Prof. Rajendra Pratap Gupta, public policy expert who serves on the Digital Health Guidelines group at WHO.
            </p>
            <p className="mb-4">
        ...
        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">The Roadmap for EHR Implementation</h2>
            <p className="mb-4">
                Currently, the Hospital Information System (HIS) software is used in India. Adoption of EHR in hospitals automates and streamlines the clinician&apos;s workflow and its adoption can be a means by which hospitals tap into improving healthcare delivery by capturing structured healthcare information.
            </p>
            <p className="mb-4">
                Only after we have the data can we think of artificial intelligence becoming a reality as the power of AI lies in its ability to analyze extremely large amounts of data coming in from a spectrum of sources – including EHRs, consumer devices, radiology, and sensor data.
            </p>
            <p className="mb-4">
                “If we feed in the data of all public hospitals, we could create a robust decision support system (DSS) tool to help newly passed-out doctors. This will be a big boost to the accuracy of diagnosis and treatment. We could impact clinical outcomes, predict seasonal outbreaks and NCDs,” added Prof. Rajendra Pratap Gupta.
            </p>
            <p className="mb-4">
                Wockhardt Group of Hospital&apos;s CHIO, Girish Koppar, believes EHR adoption will see the evolution of predictive treatment rather than reactive treatment and help in leveraging AI and ML technologies which can be life-saving.
            </p>
        </section>

        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Current Status and Future Directions</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
                “Electronic health records were never a technology challenge but an adoption challenge which only dissolves when clinicians realize the potential of EHR or when there is a mandate either from top management or from the government,” said Prashant Singh, Director and Chief Information Officer at Max Healthcare.
            </p>
            <p className="mb-4">
                Max Healthcare, which uses the Vista EHR system, is currently leveraging speech-to-text technology to capture data for reducing medical errors in medicine administration. The hospital is also evaluating technologies to make EHR available on the doctors tablet or mobile for better patient care and data capturing.
            </p>
        </section>

        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Addressing EHR Implementation Challenges</h2>
            <p className="mb-4">
                Different hospitals can have varied budgets and approaches to the adoption of electronic healthcare records. Now while data can be available in many formats, it is important to mandate some standards for the data to be analyzable and to achieve interoperability.
            </p>
            <p className="mb-4">
                Deen Sulbigar Ali Ahamed, Group Head of IT, Columbia Asia Group of Hospitals, emphasized the need for significant adoption of common EHR data standards such as FHIR to ensure seamless transfer of patient data between hospitals.
            </p>
            <p className="mb-4">
                “Gaps in EHR data for any given patient (for example, data from a particular provider is missing) can significantly reduce the credibility of data and practitioners would be unwilling to make clinical decisions based on EHR.”
            </p>
            <p className="mb-4">
                There has to be greater emphasis on the quality of the available clinical data without errors which is critical to enable widespread adoption. The review report prepared by MeitY revealed infrastructure creation, policy and regulations, standards, and interoperability as challenges.
            </p>
            <p className="mb-4">
                Prashant Singh shared similar concerns, “EHR standards on the ground are nowhere. Government of India has not mandated those records as of now and it is available as a part of minimum data sets for EHR.”
            </p>
            <p className="mb-4">
        ...
        <section className="mb-6">
            <h2 className="text-xl font-semibold mb-2">Scaling EHR Adoption through Incentives</h2>
            <p className="mb-4">
                EHR implementation, which is a long-drawn effort, requires significant spends on technology, people, and data digitization. While a few private hospitals do have some kind of EHR system in place, the majority of hospitals are still functioning on handwritten reports.
            </p>
            <p className="mb-4">
                This non-adoption of an EHR system is further delaying the collection of the required amount of data. One of the measures suggested by Prof. Rajendra Pratap Gupta is that the Ministry of Health should get a basic ‘functional EHR’ developed, host it on a secure cloud (Health Information Exchange), and give it for free to clinicians and hospitals.
            </p>
            <p className="mb-4">
